...
-------------------------------
The below code (in [demo_aad.py](python/aad/demo_aad.py)) shows the simpest AAD implementation that can be used by other developers. To execute:
