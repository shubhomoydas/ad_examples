...
def get_glad_option_list():
    ...
    parser.add_argument("--max_afss_epochs", type=int, default=1, required=False,
                        help="Max number of epochs AFSS will be trained in each feedback cycle")
    parser.add_argument("--afss_c_tau", type=float, default=1.0, required=False,
                        help="Penalty factor for aad loss with AFSS")
    parser.add_argument("--afss_l2_lambda", type=float, default=1e-3, required=False,
                        help="L2 Penalty term for AFSS parameters")
...
class GladOpts(object):
    def __init__(self, args):
        ...
        self.max_afss_epochs = args.max_afss_epochs
